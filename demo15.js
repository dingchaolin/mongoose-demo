...
T.remove({},function(){
    T.create(arr).then(function(objs){
        ...
        //})
        //或 $or
        //T.find({$or:[{name:'leo1'},{num:2},{num:4}]},function(err,res){
        //    console.log(res);
        //});
        // 亦或  是或的反面 除了这3个其他的都会被返回
        //T.find({$nor:[{name:'leo1'},{num:2},{num:4}]},function(err,res){
        //    console.log(res);
        //});
        // and 条件都满足
        //T.find({$and:[{name:/^leo1\d$/},{num:{$lt:15}}]},function(err,res){
        //    console.log(res);
        //});
        //T.find({$and:[{$or:[{name:'leo1'},{num:2},{num:4}]},{num:2}]},function(err,res){
        //    console.log(res);
        //});
        // $not
        T.find({num:{$not:{$gte:10}}},function(err,res){
            console.log(res);
        });
